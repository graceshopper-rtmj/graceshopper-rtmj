...
async function seed() {
  ...
  const chocolateBar = await Product.create({
    ...
    description: 'A four pack of our best-selling chocolate protein bar. Packed with 20g of sustainable grasshopper protein, providing you with all of your essential amino acids, B12, and omega-3s - and over twice as much iron as spinach. , making it a sustainable alternative to traditional animal-based protein sources.',
    quantity: 50,
    type: 'bar'
  })
  ...
  const mintChocolateBar = await Product.create({
    ...
    description: 'A four pack of our new mint chocolate protein bar. Packed with 20g of sustainable grasshopper protein, providing you with all of your essential amino acids, B12, and omega-3s - and over twice as much iron as spinach. ',
    quantity: 50,
    type: 'bar'
  })
  ...
  const pbBar = await Product.create({
    ...
    price: 15,
    imageURL: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQtBCTSCghmdU27j_uDgTLVxpnLRBB-ZjpmhA&usqp=CAU',
    description: 'A four pack of your favorite chocolate, now in a protein bar. Packed with 20g of sustainable grasshopper protein, providing you with all of your essential amino acids, B12, and omega-3s - and over twice as much iron as spinach. Grasshopper flour is over 70% protein by volume, ',
    quantity: 50,
    type: 'bar'
  })
